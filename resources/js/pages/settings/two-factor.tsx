                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                demandé lors de la connexion, que vous pouvez
                                obtenir depuis une application TOTP sur votre
                                téléphone.
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                facteurs, il vous sera demandé un code sécurisé
                                lors de la connexion. Ce code peut être obtenu
                                depuis une application TOTP sur votre téléphone.
                            </p>
